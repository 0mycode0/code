...
from utils.OELA import OELA
from utils.MRSA import MRSA
...
class MainNet(nn.Module):
    ...
    def forward(self, x, status='test', DEVICE='cuda'):
        ...
        #object branch
        coordinates = torch.tensor(OELA(fm.detach()))
        ...
        return   raw_logits, object_logits,  parts_logits
